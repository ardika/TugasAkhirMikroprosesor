if (!self._FC2COUNTER14825134_1)
{
	var _FC2COUNTER14825134_1 =
	{
		id:14825134,
		graph_img:null,
		show_graph:function(e)
		{
			if (this.graph_img == null )
			{
				...
				img.src = 'http://panel.counter1.fc2.com/popup.php?id=14825134&main=1&lang=0';
		...
		disp_js:function()
		{
			document.write('<script type="text/javascript" language="javascript"'
				+ ' src="http://counter1.fc2.com/counter_js.php?id=14825134&main=1&lang=0'
